...
namespace NinjaTrader.Data
{
  /// <summary>
  /// </summary>
    public class RichVolume : BarsType, rwt.IExtendedData
  {
        ...
        private static bool registered = Data.BarsType.Register(new RichVolume());
    ...
    {
      return "RichVolume " + period.Value.ToString();
    }
  }
